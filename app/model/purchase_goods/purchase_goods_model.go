...
// arModel is a active record design model for table purchase_goods operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of purchase_goods.
	Table = "purchase_goods"
	// Model is the model object of purchase_goods.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table purchase_goods.
	Columns = struct {

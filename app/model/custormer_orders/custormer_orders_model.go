...
// arModel is a active record design model for table custormer_orders operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of custormer_orders.
	Table = "custormer_orders"
	// Model is the model object of custormer_orders.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table custormer_orders.
	Columns = struct {
		Id              string //
		CreatedAt       string //
		UpdatedAt       string //

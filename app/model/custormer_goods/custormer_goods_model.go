...
// arModel is a active record design model for table custormer_goods operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of custormer_goods.
	Table = "custormer_goods"
	// Model is the model object of custormer_goods.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table custormer_goods.
	Columns = struct {
		CustormerOrderId  string //   
        GoodsId           string //   
        Number            string //
	}{
		CustormerOrderId: "custormer_order_id",  
        GoodsId:          "goods_id",            
        Number:           "number",
	}
)

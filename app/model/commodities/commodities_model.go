...
// arModel is a active record design model for table commodities operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of commodities.
	Table = "commodities"
	// Model is the model object of commodities.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table commodities.
	Columns = struct {
		Id             string //   
        Name           string //   
        Colour         string //   

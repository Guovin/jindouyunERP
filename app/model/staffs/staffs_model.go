...
// arModel is a active record design model for table staffs operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of staffs.
	Table = "staffs"
	// Model is the model object of staffs.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table staffs.
	Columns = struct {
		Id       string //   
        Name     string //   
        Age      string //   

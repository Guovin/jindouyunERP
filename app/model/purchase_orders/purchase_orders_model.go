...
// arModel is a active record design model for table purchase_orders operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of purchase_orders.
	Table = "purchase_orders"
	// Model is the model object of purchase_orders.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table purchase_orders.
	Columns = struct {
		Id        string //
		CreatedAt string //
		UpdatedAt string //
